...
CONF_OUTDOOR_TEMP_ENTITY = "outdoor_temp_entity"  # sensor.met_office_weoley_castle_temperature
...
CONF_HEAT_DEMAND_ENTITY = "heat_demand_entity"  # sensor.01_144444_heat_demand
